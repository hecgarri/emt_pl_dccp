  ...
  ui <- fluidPage(
    ...
    headerPanel(
      title = div(
        ...
        "Consultas Data Warehouse Institucional",
        tags$br(),  # Salto de línea
        p("Esta aplicación permite realizar consultas estandarizadas al DataWareHouse Institucional", style = "font-size: 20px;")
      )
    ),
    ...
    tabsetPanel(
      ...
      tabPanel("Órdenes de compra",
        ...
        ,tags$footer(
          ...
          p("© Desarrollado por División de Estudios y Políticas de Compra", style = "font-size: 15px;")
        )
