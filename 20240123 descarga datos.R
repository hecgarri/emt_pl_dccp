...
usuarios_matched <- sqldf("
                          select distinct
                          datos.[Razón Social Comprador]
                          ,datos.[Razón Social Unidad de Compra]
                          ,datos.[NombreRegion.x]
                          ,datos.[Razón Social Proveedor]
                          ,datos.level1
                          ,datos.level2
                          ,datos.level3
                          ,datos.productoname
                          ,datos.[Región de Despacho]
                          ,usuarios.[Rut Proveedor]
                          ,usuarios.[Mes]
                          ,usuarios.[Anio]
                          ,usuarios.[usrEmail]
                          ...
                          ,usuarios.[usrTaxID]
                          ,usuarios.[usrPhone]
                          ,usuarios.[usrPosition]
                          from datos 
                          inner join usuarios on datos.entCode = usuarios.EntCode
                          ") 
